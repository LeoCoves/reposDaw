...
namespace TiendaPadel.Migrations
{
    ...
    [Migration("20250109144950_SetEscaparateFalse")]
    partial class SetEscaparateFalse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TiendaPadel.Models.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TiendaPadel.Models.Detalle", b =>
                {
                    b.HasOne("TiendaPadel.Models.Pedido", "Pedido")
                        .WithMany("Detalles")
                        .HasForeignKey("PedidoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TiendaPadel.Models.Producto", "Producto")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("TiendaPadel.Models.Pedido", b =>
                {
                    b.HasOne("TiendaPadel.Models.Cliente", "Cliente")
                        .WithMany("Pedidos")
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TiendaPadel.Models.Estado", "Estado")
                        .WithMany("Pedidos")
            ...
            modelBuilder.Entity("TiendaPadel.Models.Producto", b =>
                {
                    b.HasOne("TiendaPadel.Models.Categoria", "Categoria")
                        .WithMany("Producto")
