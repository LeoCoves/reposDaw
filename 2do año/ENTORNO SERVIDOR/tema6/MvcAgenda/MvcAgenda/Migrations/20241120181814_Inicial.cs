        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeparatamentoId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Empleados", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Empleados_Departamentos_DeparatamentoId",
                        column: x => x.DeparatamentoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Empleados_DeparatamentoId",
                table: "Empleados",
                column: "DeparatamentoId");
